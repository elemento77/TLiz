/**
 * Footer Section — Esoteric Tarot
 * Minimal dark footer with contact and legal links.
 */
...
export default function FooterSection() {
  ...
  return (
    <footer id="contato" className="border-t border-surface bg-void">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l.label}>
                  <a href={l.href} className="font-body text-xs text-smoke/60 hover:text-gold transition-colors">
                    {l.label}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-surface/50 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            {[
              ...
              <a key={l.label} href={l.href} className="font-body text-[10px] text-smoke/30 hover:text-smoke/60 transition-colors">
                {l.label}
              </a>
            ))}
          </div>
