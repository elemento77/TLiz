/**
 * Disclaimer Section — Legal Notice
 * Glassmorphism card clarifying the symbolic nature of tarot readings.
 */
  ...
  return (
    ...
    >
      <div className="container">
        <div className="max-w-2xl mx-auto glass-panel p-6 flex gap-4 items-start">
